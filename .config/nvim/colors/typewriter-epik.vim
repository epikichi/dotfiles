...
hi Boolean         ctermfg=229 ctermbg=NONE guifg=#D0D0D0 guibg=NONE cterm=NONE
...
hi Operator        ctermfg=244 ctermbg=NONE guifg=#A8A8A8 guibg=NONE
hi Error           ctermfg=9   ctermbg=NONE guifg=#FF0000 guibg=NONE
hi SpellBad        ctermfg=160 ctermbg=NONE guifg=#E06C75 guibg=NONE
hi TODO            ctermfg=11 ctermbg=NONE guifg=#AF5FFF guibg=NONE cterm=italic
...
hi Search          ctermfg=234 ctermbg=243  guifg=#1C1C1C guibg=#AFD7FF term=bold cterm=bold gui=bold
hi IncSearch       ctermfg=234 ctermbg=243  guifg=#1C1C1C guibg=#87FFAF term=bold cterm=bold gui=bold
